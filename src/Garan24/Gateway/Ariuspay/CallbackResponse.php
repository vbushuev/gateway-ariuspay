...
class CallbackResponse extends Response{
    ...
    public function accept(){
        switch(trim($this->_params["status"])){
            case "error":
                throw new Garan24GatewayAruispayException("Transaction is declined but something went wrong, please inform your account manager.",500);
            case "declined":
                throw new Garan24GatewayAruispayException("Transaction is declined.",500);
            case "filtered":
                    throw new Garan24GatewayAruispayException("Transaction is declined by fraud internal or external control systems.",500);
            case "unknown":
            case "processing":
                return false;
            case "approved":
